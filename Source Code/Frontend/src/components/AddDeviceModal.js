            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
                <div className="card shrink-0 w-full max-w-sm">
                    <form className="card-body" onSubmit={addDevice}>
                        <h2 className="text-xl font-bold text-center mb-4 text-black">Add Device</h2>
                        <div className="mb-4 ">
                            <label htmlFor="deviceName" className="block text-black font-semibold">Device Name:</label>
                            <input
                                type="text"
                                id="deviceName"
                        ...
                        <div className="mb-4">
                            <label htmlFor="deviceID" className="block text-black font-semibold">Device ID:</label>
                            <input
                                type="text"
                                id="deviceID"
                                className="mt-1 p-2 w-full border rounded"
                        ...
                        <div className="mb-4">
                            <label htmlFor="deviceType" className="block text-black font-semibold">Device Type:</label>
                        ...
                        <div className="form-control">
                            <button type="submit" className="btn text-white w-full mt-6" onClick={addDevice}>
                                Add Device
                            </button>
                        </div>
                    </form>
